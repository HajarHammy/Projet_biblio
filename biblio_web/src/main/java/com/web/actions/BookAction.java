...
public class BookAction extends BaseAction {
	 ...
	 * @return
	 */
	@Action(value = "showFormUpdate", results = { @Result(name = "updateform", location = "/pages/formModifyBook.jsp") })
	 ...
	 * @return
	 */
	@Actions({	@Action(value = "/", results = { @Result( location = "/pages/form.jsp")}),
				@Action(value = "showFormAdd", results = { @Result(name = "saveform", location = "/pages/form.jsp") })
			})
	...
	@Action(value = "updateBook", results = { 	
			...
			@Result (name= "success", location = "/pages/formModifyBook.jsp")})
